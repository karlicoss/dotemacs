...
;;; NOTE: run vimdiff config.el ~/.config/emacs/core/templates/config.example.el now and then to sync changes
...
(after! undo-tree
  ;; https://github.com/hlissner/doom-emacs/issues/1407#issuecomment-492187878
